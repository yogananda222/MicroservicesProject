...
<html>
<head>
    <title>REVSHOP - Retailers List</title>
...
<div class="main">
    <div id="dashboard" class="content-section">
        <div class="box-container">
            <div class="container">
                <h2>List of Retailer Requests</h2>
                ...
                <th>Actions</th>
                    ...
                    <tbody>
                        <c:choose>
                            <c:when test="${not empty retailersList}">
            <c:forEach var="retailer" items="${retailersList}">
                <tr>
                    ...
                    <td>${retailer.contactNo}</td>
                                        <td>
                        <form action="${pageContext.request.contextPath}/approveRetailerRequest" method="post" style="display:inline;">
                            <input type="hidden" name="retailerId" value="${retailer.retailerId}"/>
                            <input type="submit" value="Approve"/>
                        </form>|
                          <button onclick="deleteRetailer(${retailer.retailerId})">Delete</button>
                    </td>
...
<script>
    function deleteRetailer(retailerId) {
        if (confirm("Are you sure you want to delete this retailer?")) {
            $.ajax({
                url: '${pageContext.request.contextPath}/deleteRetailerRequest',
                type: 'DELETE',
                ...
                error: function(xhr, status, error) {
                    alert("Error deleting retailer: " + xhr.responseText);
                }
            });
        }
    }
