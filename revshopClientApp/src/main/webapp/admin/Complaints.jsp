...
<title>REVSHOP - Complaints</title>
    ...
    <div id="dashboard" class="content-section">
        <div class="box-container">
            <div class="container">
                ...
                <tr>
                    <td>${complaints.complaintId}</td> <!-- Assuming Buyer has a method getId() -->
                    <td>${complaints.subject}</td> <!-- Assuming Buyer has a method getName() -->
                    <td>${complaints.complaintText}</td> <!-- Assuming Buyer has a method getEmail() -->
                    <td>${complaints.buyer.name}</td> <!-- Assuming Buyer has a method getContactNo() -->
                    <td>${complaints.retailer.businessName}</td>
                </tr>
            </c:forEach>
</tbody>
</table>
